...
//==========================================================================================================
bool NetSock::connect(std::string server, int port, int family, string interface)
{
    addrinfo_t info;
...
//                    bound to that port.
//==========================================================================================================
bool NetSock::create_server(int port, string bind_to, int family, string interface)
{
    // The socket is not yet created
    m_is_created = false;
